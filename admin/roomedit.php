    ...
    <div class="w-full max-w-4xl bg-white shadow-lg rounded-lg overflow-hidden">
        ...
        <form action="./roomupdate.php" method="POST" class="grid grid-cols-1 md:grid-cols-3 gap-4 px-6 py-4 bg-gray-50 border-b border-gray-300">
            ...
            <div>
                ...
                <select name="room_type_edit" id="room_type" class="w-full px-3 py-2 border border-gray-300 rounded focus:ring-2 focus:ring-green-400">
                ...
                <input type="number" name="room_rent_edit" id="room_rent" value="<?php echo $row['room_rent'] ?>" class="w-full px-3 py-2 border border-gray-300 rounded focus:ring-2 focus:ring-green-400" placeholder="Input Room Rent">
            </div>

            <!-- Bed Type Select -->
            <div>
                <label for="bed_type" class="block text-sm font-medium text-gray-700 mb-1">Bed Type</label>
                <select name="bed_type_edit" id="bed_type" class="w-full px-3 py-2 border border-gray-300 rounded focus:ring-2 focus:ring-green-400">
